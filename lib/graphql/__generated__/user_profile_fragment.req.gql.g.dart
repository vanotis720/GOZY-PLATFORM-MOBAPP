...
part of 'user_profile_fragment.req.gql.dart';
...
Serializer<GuserProfileFragmentReq> _$guserProfileFragmentReqSerializer =
    new _$GuserProfileFragmentReqSerializer();
...
class _$GuserProfileFragmentReqSerializer
  ...
  Iterable<Object?> serialize(
      Serializers serializers, GuserProfileFragmentReq object,
  ...
  GuserProfileFragmentReq deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GuserProfileFragmentReqBuilder();
...
class _$GuserProfileFragmentReq extends GuserProfileFragmentReq {
  ...
  factory _$GuserProfileFragmentReq(
      ...
      (new GuserProfileFragmentReqBuilder()..update(updates))._build();
  ...
  _$GuserProfileFragmentReq._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        vars, r'GuserProfileFragmentReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        document, r'GuserProfileFragmentReq', 'document');
    BuiltValueNullFieldError.checkNotNull(
        idFields, r'GuserProfileFragmentReq', 'idFields');
  }
  ...
  GuserProfileFragmentReqBuilder toBuilder() =>
      new GuserProfileFragmentReqBuilder()..replace(this);
...
class GuserProfileFragmentReqBuilder
  ...
  _i3.GuserProfileFragmentVarsBuilder get vars =>
      _$this._vars ??= new _i3.GuserProfileFragmentVarsBuilder();
  ...
  _$GuserProfileFragmentReq _build() {
    ...
    try {
      _$result = _$v ??
          new _$GuserProfileFragmentReq._(
              vars: vars.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GuserProfileFragmentReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
